...
#define JOYLINK_MSG_ID_SET_HOME_POSITION 243

typedef struct _joylink_set_home_position {
...
} joylink_set_home_position;

#define JOYLINK_MSG_ID_SET_HOME_POSITION_LEN 53

static inline uint16_t joylink_msg_set_home_position_pack(uint8_t dev_id, joylink_message* msg,
...
{
    joylink_set_home_position packet;
    ...
    memcpy(_JOY_PAYLOAD_NON_CONST(msg), &packet, JOYLINK_MSG_ID_SET_HOME_POSITION_LEN);

    msg->msgid = JOYLINK_MSG_ID_SET_HOME_POSITION;
    return joylink_finalize_message(msg, dev_id, JOYLINK_MSG_ID_SET_HOME_POSITION_LEN);
}

static inline void joylink_msg_set_home_position_send_struct(joylink_channel chan, const joylink_set_home_position* set_home_position)
{

  joylink_finalize_message_chan_send(chan, JOYLINK_MSG_ID_SET_HOME_POSITION, (const char *)set_home_position,JOYLINK_MSG_ID_SET_HOME_POSITION_LEN);
}


static inline uint8_t joylink_msg_set_home_position_get_target_system(const joylink_message* msg)
{
    return JOY_RETURN_uint8_t(msg,  52);
}

static inline int32_t joylink_msg_set_home_position_get_latitude(const joylink_message* msg)
{
    return JOY_RETURN_int32_t(msg,  0);
}

static inline int32_t joylink_msg_set_home_position_get_longitude(const joylink_message* msg)
{
    return JOY_RETURN_int32_t(msg,  4);
}


static inline int32_t joylink_msg_set_home_position_get_altitude(const joylink_message* msg)
{
    return JOY_RETURN_int32_t(msg,  8);
}

static inline float joylink_msg_set_home_position_get_x(const joylink_message* msg)
{
    return JOY_RETURN_float(msg,  12);
}

static inline float joylink_msg_set_home_position_get_y(const joylink_message* msg)
{
    return JOY_RETURN_float(msg,  16);
}

static inline float joylink_msg_set_home_position_get_z(const joylink_message* msg)
{
    return JOY_RETURN_float(msg,  20);
}

static inline uint16_t joylink_msg_set_home_position_get_q(const joylink_message* msg, float *q)
{
    return JOY_RETURN_float_array(msg, q, 4,  24);
}

static inline float joylink_msg_set_home_position_get_approach_x(const joylink_message* msg)
{
    return JOY_RETURN_float(msg,  40);
}

static inline float joylink_msg_set_home_position_get_approach_y(const joylink_message* msg)
{
    return JOY_RETURN_float(msg,  44);
}

static inline float joylink_msg_set_home_position_get_approach_z(const joylink_message* msg)
{
